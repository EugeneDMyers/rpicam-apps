 ...
 *
 * kipr_posenet.cpp - IMX500 inference for PoseNet
 */
...
#define NAME "kipr_posenet"

class PoseNet : public KIPRPostProcessingStage
{
public:
	PoseNet(RPiCamApp *app) : KIPRPostProcessingStage(app) {}
